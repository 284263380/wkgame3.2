...
def build_update_ant():
    os.system('del local.properties')
    os.system('del project.properties')
    os.system('del proguard-project.txt')
    os.system('android update project -p . -t 1')
    os.system('ant clean')
    os.system('ant debug')
    os.system('pause')
# -------------- main --------------
